...
class AbertosFragment(val listAbertos : List<Ticket>,
                      ) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val rv = view.findViewById<RecyclerView>(R.id.rv_abertos)
        rv.adapter = TicketsRespondidosAdapter(listAbertos) { it ->
